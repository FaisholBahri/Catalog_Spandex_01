...
initColorCss:function(){this.stage.css({background:this.mainColorObj.rgba(.6),color:this.fontColor});this.title.css({color:this.fontColor});this.progressBar.css({background:this.fontColor})},initDefaultDom:function(){this.closeUrl=form_icons.close?"data:image/png;base64,"+form_icons.close:uiBaseURL+"close.png";this.close=$("<img alt='close' width='auto' height='auto' class='close' src='"+this.closeUrl+"'/>");this.close.click(this.hide.bind(this));this.close.changeButtonColor(this.fontColor);(this.favicon=
$("<img class='favicon' src='"+FormInfo.getFormFavicon("thumbnail")+"'/>"))&&this.favicon.changeButtonColor(this.fontColor);this.initSwiper()},initSwiper:function(){this.thumbnailSwiper=$("<div class='thumbnailSwiper stage'></div>");this.thumbnailSwiperList=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.topTitle=$('<div class="thumbnailTopTitle"></div>');this.title=$('<div class="thumbnail_title"><span>'+FormInfo.getFormTitle("thumbnail")+
"</span></div>");this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.topTitle.append(this.title,this.close);this.refreshSwiper(this.thumbnailSwiperList);this.thumbnailSwiper.append(this.thumbnailSwiperList);this.thumbnailSwiper.append(this.progress);this.progress.append(this.progressBar)},initEvent:function(){this.thumbnailSwiper.scroll({},Direction.top)},onResize:function(){this.height=windowHeight-40;this.refresh();this.thumbnailSwiperList.width();
this.stage.css({width:"260px",height:this.height})},refresh:function(){this.thumbnailSwiper.refreshData();this.thumbnailSwiper.css({width:"260px",height:"99%"})},refreshSwiper:function(a){this.length=0;for(var b=BookInfo.getThumbnailPages(),c=0;c<b.length;c++)this.addItem(a,b[c]);a.css({width:"260px",height:this.topLength+"px"})},mergeAll:function(){for(var a=0;a<this.itemArray.length;a++)this.itemArray[a].merge()},fissionAll:function(){for(var a=0;a<this.itemArray.length;a++)this.itemArray[a].fission()},
addItem:function(a,b){a=new ThumbnailItem(a,b);a.setPosition(this.topLength,this.direction);this.topLength+=this.height;this.topLength+=this.margin;this.itemArray.push(a)},clearHighLight:function(){$(".highlight").removeClass("highlight")},setHighLight:function(a){$(".highlight").removeClass("highlight");for(var b=0;b<this.itemArray.length;b++)0<=this.itemArray[b].pages.indexOf(a)&&this.itemArray[b].setHighLight(a);window.setTimeout(this.thumbnailSwiper.animateToCenterItem,10)},getShowStatu:function(){return this.visible},
getHeight:function(){return 0},getTopHeight:function(){return 0},getBottomHeight:function(){return 0},fillImage:function(a){this.itemArray&&this.itemArray[a]&&!this.itemArray[a].fill&&(this.LoadCount++,this.itemArray[a].fillContent(),this.itemArray[a].fill=!0)},fillContent:function(){this.interval&&!this.interval.isRunning()?this.interval.start():this.interval=function(){this.performTask()}.interval(this,60)},performTask:function(){var a=this.getShownItems(),b=a[1];for(a=a[0];a<=b;a++){var c=function(){thumbnail.fillImage(this.index)}.bind({index:a});
c.id=a;this.taskList.unShiftTask(c)}},getShownItems:function(){var a=this.thumbnailSwiper.stageLength,b=-this.thumbnailSwiper.getCurrentLength(),c=this.itemArray[0].length+this.itemArray[0].margin;a=parseInt(a/c)+2;b=parseInt(b/c);c=Math.min(b+a,this.itemArray.length);b=Math.max(0,b);return[b,c]},showOrHide:function(){this.visible?this.hide():this.show();onStageResize()},show:function(){this.refresh();this.setHighLight(BookInfo.getCurrentPageIndex());this.visible=!0;this.stage.animate({right:"0"},
400,function(){this.fillContent();this.setA11yAndFocus()}.bind(this))},hide:function(a){this.interval&&this.interval.stop();this.visible=!1;this.stage.animate({right:"-300px"},400,function(){this.onHide()}.bind(this))}}).extend(FormFrame);var ThumbnailForm=Class({create:function(a){this.direction=0;this.height=130;this.topLength=10;this.margin=30;this._super(a);window.mutexForms||(window.mutexForms=[]);window.mutexForms.push(this)},initHtml:function(){this.stage=$("<div class='thumbnail_win10'></div>");this.stage.append(this.thumbnailSwiper,this.topTitle);this.stage.append(this.pageCaption);this.parent.append(this.stage)}}).extend(ThumbnailFrame);var toolbar_icons={First:"",
prev:"",
next:"",
Last:"",
home:"",
ZoomIn:"",
ZoomOut:"",
search:"",
thumbnails:"",
tableOfContent:"",
bookmark:"",
autoPlay:"",
stopAutoPlay:"",
soundOn:"",
soundOff:"",
annotation:"",videoGallery:"",
photoGallery:"",
sharethis:"",
print:"",
message:"",download:"",
fullscreen:"",
exitFullscreen:"",
languageChange:"",
about:"",
Help:"",
moreBar:"",
backward:"",
forward:"",
...
emailButton:"",
wechat:"",
magnifier:"",
text:"",phone:"",
previous_normal:"",
previous_normal_down:"",
next_normal_down:"",
next_normal:""};Class("ButtonQueue",{create:function(a){this.container=a.container;this.extended=a.extended;this.edtNumber=a.edtNumber?a.edtNumber:{body:null,width:0,top:0,space:0};this.buttonWidth=a.buttonWidth;this.buttonTop=a.buttonTop;this.buttons=a.buttons.clone();this.buttonCount=this.buttons.length;this.buttons.each(function(b){b.freedom();b.$button.removeClass("left");b.$button.removeClass("right");b.hint=!0});this.pickButtons()},pickButtons:function(){this.btnFirst=this.buttons.find("first").get(0);this.btnPrevious=
...
Class("PCButtonQueue",{sort:function(){var a=this.edtNumber.width+2*this.edtNumber.space+this.pageButtonCount*this.buttonWidth,b=Math.floor((this.container.width-10-a)/this.buttonWidth);b=Number.between(b,0,this.buttonCount);a=(this.container.width-a-b*this.buttonWidth)/2;var c=Math.ceil(b/2);b<this.buttonCount&&b--;0>=b&&(a=this.addPageButtons(a));for(var d=0;d<this.buttons.length;d++){var e=this.buttons.get(d);d<b?(e==this.buttons.find("sound").get(0)&&(e.title=!1,VolumeControlBar.config.direction=
VolumeControlBar.TOP),"WeChatShareButton"==e.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.TOP),e.addTo(this.container.body),e.setPosition(a,this.buttonTop),d<c?e.$button.addClass("left"):e.$button.addClass("right"),a+=this.buttonWidth,d==c-1&&(a=this.addPageButtons(a))):(e==this.buttons.find("sound").get(0)&&(e.title=!1,VolumeControlBar.config.direction=VolumeControlBar.DEFAULT),"WeChatShareButton"==e.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.LEFT),e.addTo(this.extended),
e.hint=!1)}b<this.buttonCount&&(this.btnMore.addTo(this.container.body),this.btnMore.setPosition(a,this.buttonTop),this.btnMore.$button.addClass("right"))},addPageButtons:function(a){function b(n){n.addTo(e);n.setPosition(f,h);f+=g}function c(){f+=l;0<d?(k.css({left:f+"px",top:m+"px",width:d+"px",display:"block"}),k.find("input").css({width:d+"px"}),f+=d):k.css({display:"none"});f+=l}var d=Math.max(Math.min(this.container.width-10-5*this.buttonWidth,this.edtNumber.width+2*this.edtNumber.space)-2*
this.edtNumber.space,0),e=this.container.body,f=a,g=this.buttonWidth,h=this.buttonTop,k=this.edtNumber.body,m=this.edtNumber.top,l=this.edtNumber.space;rightToLeft?(bookConfig.enablePageBack&&(b(this.btnForward),this.btnForward.$button.addClass("left")),b(this.btnLast),this.btnLast.$button.addClass("left"),b(this.btnNext),this.btnNext.$button.addClass("left"),c(),f+=5,b(this.btnPrevious),this.btnPrevious.$button.addClass("right"),b(this.btnFirst),this.btnFirst.$button.addClass("right"),bookConfig.enablePageBack&&
(b(this.btnBackward),this.btnBackward.$button.addClass("right"))):(bookConfig.enablePageBack&&(b(this.btnBackward),this.btnBackward.$button.addClass("left")),b(this.btnFirst),this.btnFirst.$button.addClass("left"),b(this.btnPrevious),this.btnPrevious.$button.addClass("left"),c(),f+=5,b(this.btnNext),this.btnNext.$button.addClass("right"),b(this.btnLast),this.btnLast.$button.addClass("right"),bookConfig.enablePageBack&&(b(this.btnForward),this.btnForward.$button.addClass("right")));return f}}).extend("ButtonQueue");
Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{initBar:function(){this.SHADOW_COLOR=Color("#1F1D1D");this.ACTIVE_SHADOW_COLOR=Color("#65FF2A");VolumeControlBar.config={color:this.color.toString(),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.TOP};this.topBar=$("<div id='fbTopBar' class='fbTopBar'></div>");this.logoBar=$("<div id='logoBar' class='logoBar'></div>");this.bottomBar=$("<div id='fbToolBar' class='fbToolBar'></div>");this.buttonBar=$("<div id='buttonBar' class='buttonBar'></div>");this.edtPageNumber=
$("<div class='pageNumber'><input id='currentPageIndexTextField' autocomplete='off' value=''></input></div>");this.parent.append(this.topBar);this.parent.append(this.bottomBar);this.topBar.append(this.logoBar);this.bottomBar.append(this.buttonBar);this.buttonBar.append(this.edtPageNumber);this.initPageNumber()},initPageNumber:function(){var a=this.edtPageNumber.find("input");a.css({color:bookConfig.pageNumColor});var b=parseInt(bookConfig.totalPageCount),c=16;""==bookConfig.pageNumberCaption&&(1E4<=
b&&(c=16),1E4>b&&(c=11),1E3>b&&(c=7),100>b&&(c=4),10>b&&(c=3));a.attr("size",c);this.edtPageWidth=this.edtPageNumber.width()+12},resetToolbarColor:function(){this.color=Color(bookConfig.toolbarColor);this.topBarAlpha=Math.min(bookConfig.topToolBarAlpha,bookConfig.ToolBarAlpha);for(var a=0;a<this.allButtons.length;a++){var b=this.allButtons[a];b.$parent[0]!=this.extendedBar.$bar[0]&&b.$button.css({background:this.color.rgba(this.topBarAlpha)})}this.extendedBar&&this.extendedBar.$bar.css({"background-color":this.color.rgba(this.topBarAlpha)})},
setButtonTitle:function(a){a.setTitle("");"WeChatShareButton"==a.getClassName()&&(global.WeChatShareImg=new WeChatShare({parent:this.parent,color:bookConfig.iconFontColor,textColor:bookConfig.toolbarColor,margin:10,padding:10,arrowHeight:10,arrowWidth:10}))},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},initEvents:function(){this._super();var a=this.edtPageNumber.find("input");a.addBorderShadow(this.SHADOW_COLOR.rgba(.6),2,2);a.bind(_event._enter,
function(){a.addBorderShadow(this.ACTIVE_SHADOW_COLOR.rgba(.7),2,2)}.bind(this));a.bind(_event._leave,function(){a.addBorderShadow(this.SHADOW_COLOR.rgba(.6),2,2)}.bind(this))},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},onResize:function(a,b){bookConfig.ToolBarVisible&&
(a=void 0==a?this.parent.width():parseInt(a),void 0==b?this.parent.height():parseInt(b),b=this.logoBar.width(),this.topBar.css({left:"0px",width:b+"px"}),b=.7*a,this.bottomBar.css({left:(a-b)/2+"px",width:b+"px"}),this.buttonBarWidth=b,this.resetButtonPosition())},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,buttonWidth:110,buttonTop:5,container:{body:this.buttonBar,width:this.buttonBarWidth},extended:this.extendedBar.$bar,edtNumber:{body:this.edtPageNumber,width:this.edtPageWidth,
top:2,space:5}})).sort();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.changeColor();var b=this.SHADOW_COLOR.rgba(.6),c=this.ACTIVE_SHADOW_COLOR.rgba(.7);a.$parent==this.buttonBar?(a.$button.css({"background-color":this.color.toString()}),a.$button.addBorderShadow(b,2,2),a.$button.bind(_event._enter,function(){$(this).addBorderShadow(c,2,2)}),a.$button.bind(_event._leave,function(){$(this).addBorderShadow(b,2,2)})):(a.$button.css({"background-color":"transparent"}),
a.$button.addBorderShadow("transparent",0,0),a.$button.asButton().mouseEnterGradient(this.color.toString(),this.color.add(30),this.color.reduce(30)))}.bind(this))}}).extend("Toolbar");
Class("PCExtendedBar",{create:function(a){this._super(a);this.SHADOW_COLOR=Color("#1F1D1D");this.ACTIVE_SHADOW_COLOR=Color("#65FF2A");this.initEvents()},initEvents:function(){this.$bar.addBorderShadow(this.SHADOW_COLOR.rgba(.6),2,2);this.$bar.bind(_event._enter,function(){this.$bar.addBorderShadow(this.ACTIVE_SHADOW_COLOR.rgba(.6),2,2)}.bind(this));this.$bar.bind(_event._leave,function(){this.$bar.addBorderShadow(this.SHADOW_COLOR.rgba(.6),2,2)}.bind(this))},show:function(a){if(1!=this.isMoving&&
1!=this.visible){this.visible=this.isMoving=!0;this.$bar.css({left:a.left+a.width-this.width+"px",top:a.top-10-this.height+"px"});var b=0;this.$bar.css({display:"block",opacity:0});var c=function(){b+=.1;this.$bar.css({opacity:b});equals(b,1)&&(c.stop(),this.isMoving=!1)}.interval(this,40)}},resize:function(a){for(var b=0;b<a.length;b++)a.get(b).setPosition(5,5+30*b);this.width=160;this.height=30*a.length+10;this.$bar.css({width:this.width+"px",height:this.height+"px"})}}).extend("ExtendedBar");var hexcase=0,b64pad="",chrsz=8;function compareov(){var a=Date.parse(new Date);return orgt(a)===vldt(a)}function orgt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}function vldt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}
